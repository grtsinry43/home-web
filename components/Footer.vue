...
<template>
  <div class="footer-container bg-opacity-25 bg-[#ccc] dark:bg-[black] dark:bg-opacity-25">
    ...
    <p class="tracking-wide">Copyright &copy; 2024 home-web by grtsinry43. All rights reserved.</p>
    <p class="tracking-wide">Licensed under the MIT License.</p>
    <br/>
    <p  class="tracking-wider"><a href="https://beian.miit.gov.cn/" target="_blank" class="mr-8 hover:text-blue-600">湘ICP备2023033970号-1</a>
